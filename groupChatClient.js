/*
 * TCP Client to interact with groupChatServer.js
 *
 * Usage: node groupChatClient.js [username]
 */

/* group server address, change this as in groupChatServer.js SERVER_HOST */
const SERVER_HOST = "127.0.0.1";
/* group server port number, change this as in groupChatServer.js SERVER_PORT */
...
socket.on('error', function(err) {
    if (err.code === 'ECONNREFUSED')
        console.log("Error:connection refused, please check the server is running");
    else
