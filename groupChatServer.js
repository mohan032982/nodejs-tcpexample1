/*
 * A (very) simple Group chat server
 * 
 */
...
serverSock.on('error', function(err) {
    if (err.code === 'EADDRINUSE') {
        console.log("Error: port %d is in use, check if another instance of the server is running or wait for a few seconds and rerun the server", SERVER_PORT);
    } else {
